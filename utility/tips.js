...
const tips_json = {
    ...
    batchNumber: "the number of images to generate at once.The larger the number more VRAM stable diffusion will use.",
    steps: "how long should stable diffusion take to generate an image",
    selection_mode_ratio: "will auto fill the width and height slider to the same ratio as the selection area",
    selection_mode_precise: "auto fill width and height slider to the size as the selection area",
    selection_mode_ignore: "you will have to fill the width and height slider manually",
    cfg_scale: "larger value will put more emphasis on the prompt",
    preset_menu: "auto fill the plugin with smart settings, to speed up your working process.",
    width: "the generated image width",
    height: "the generated image height",
    mask_expansion: "the larger the value the more the mask will expand, '0' means use precise masking, use in combination with the mask blur",
    mask_content_fill: ""
}
