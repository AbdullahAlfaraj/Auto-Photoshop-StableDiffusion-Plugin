...
async function getUniqueDocumentId() {
  try {
    ...
    console.log("getUniqueDocumentId():  uniqueDocumentId: ", uniqueDocumentId)
  ...
  theTab.onclick = () => {
    try {
      ...
      Array.from(document.querySelectorAll(".sp-tab-page")).forEach(
        (tabPage) => {
          if (
            tabPage.getAttribute("id").startsWith(theTab.getAttribute("id"))
          ) {
...
function autoFillInSettings(metadata_json) {
  try {
    metadata_json1 = {
      prompt:
        "cute cat, A full portrait of a beautiful post apocalyptic offworld arctic explorer, intricate, elegant, highly detailed, digital painting, artstation, concept art, smooth, sharp focus, illustration\nNegative prompt:  ((((ugly)))), (((duplicate))), ((morbid)), ((mutilated)), out of frame, extra fingers, mutated hands, ((poorly drawn hands)), ((poorly drawn face)), (((mutation))), (((deformed))), ((ugly)), blurry, ((bad anatomy)), (((bad proportions))), ((extra limbs)), cloned face, (((disfigured))), out of frame, ugly, extra limbs, (bad anatomy), gross proportions, (malformed limbs), ((missing arms)), ((missing legs)), (((extra arms))), (((extra legs))), mutated hands, (fused fingers), (too many fingers), (((long neck)))",
      Steps: "20",
      Sampler: "Euler a",
      "CFG scale": "7.0",
      Seed: "2300061620",
      ...
      setTimeout(() => {
        try {
          document.getElementById("tableInitImageContainer").style.display =
            "table" // show the table after some time so it gets rendered.
        } catch (e) {
          console.warn(e)
        }
      }, 100)
      ...
      for (const path of paths) {
        if (!g_viewer_manager.hasViewerImage(path)) {
          ...
          const solid_background =
            g_viewer_manager.initImageLayersJson[path].solid_background
          const auto_delete =
  ...
  .addEventListener("click", async function () {
    try {
      ...
      for (image_path of image_paths) {
        ...
        img_container = viewer.Thumbnail.wrapImgInContainer(
          img,
          "thumbnail-image-container"
        )
        viewer.Thumbnail.addSPButtonToContainer(
          img_container,
